...
import { OverflowMenuVertical, UserFollow, View, ViewMode_1, ViewOff } from "@carbon/icons-react";
...
export const MoreOptionsDropdown = () => {
  ...
  return (
    <>
      ...
      >
        <DropdownTrigger>
          <Button className="rounded-full" disableRipple size="sm" isIconOnly variant="ghost">
